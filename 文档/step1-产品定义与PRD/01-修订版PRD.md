...
| 5 | "即时通讯 IM（进阶）" | 无 chat/message 表 | 🟢 选做 | **接受偏差**，标"选做未实现" |
...
- **文档/代码吻合率**：约 75%（去掉"选做未实现"项后约 90%）
- **最大风险点**：信用分上限 100 vs 150 的偏差，**已修复 PRD**
- **最大遗留缺口**：校园实名认证、提现、团队组队、IM、GeoHash、AI 审核 6 项**未实现**，将在 §7 范围界定中明确说明
...
| 即时通讯 IM | P3 | ❌ 选做 | 复杂度大，平台担保机制已能约束基础行为 |
